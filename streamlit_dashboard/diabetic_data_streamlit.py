...
ax2 = sns.scatterplot(x = user_data['Age'], y = user_data['BloodPressure'], s = 150, color = color)     # s = graph scale
...
# st.write(mean_absolute_error(y, user_result))
# st.subheader("Mean squared error of model is: ")
# st.write(mean_squared_error(y, user_result))
# st.subheader("r2_score (r-square score) of model is: ")
# st.write(r2_score(y, user_result))
